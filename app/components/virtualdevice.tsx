...
import { registerClearLED, registerPlayAuto, registerLoad, registerInputChanged, registerUpdateChainLED, registerPress } from "@/store/registerHandlers";
...
export default function VirtualDevice() {
  ...
  const [gridStates, setGridStates] = useState(() => Array(10 * 10).fill("80,80,80"));
